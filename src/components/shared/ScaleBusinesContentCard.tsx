...
const ScaleBusinesContentCard: React.FC<ScaleBusinessContentCardProps> = ({
  ...
  return (
    <div className="w-full h-full py-12 pl-6 pr-6 lg:pl-12 lg:pr-0 flex flex-col lg:flex-row gap-40 lg:gap-20 justify-between bg-[#CDC6FB] lg:bg-[#EBE8FE] lg:rounded-[28px] min-h-[400px] lg:min-h-[500px] xl:min-h-[650px]">
      ...
      <Image
        src={image}
        alt="image"
        className="w-full h-full object-cover lg:rounded-tl-3xl lg:rounded-bl-3xl min-h-[400px] lg:min-h-[500px] xl:min-h-[650px] min-w-[400px] lg:min-w-[500px] xl:min-w-[750px]"
      />
    </div>
  );
};
