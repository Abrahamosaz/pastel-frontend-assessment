...
const ScaleBusinesContentCard: React.FC<ScaleBusinessContentCardProps> = ({
  ...
  return (
    <div className="w-full h-full py-12 pl-12 flex gap-10 md:gap-20 justify-between bg-[#EBE8FE] rounded-[28px] min-h-[500px] xl:min-h-[650px]">
      ...
      <Image
        src={image}
        alt="image"
        className="w-full h-full object-cover rounded-tl-3xl rounded-bl-3xl min-h-[500px] xl:min-h-[650px] min-w-[500px] xl:min-w-[750px]"
      />
    </div>
  );
};
